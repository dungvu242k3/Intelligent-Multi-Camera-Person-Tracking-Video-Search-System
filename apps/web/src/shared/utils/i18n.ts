...
export const i18nDict = {
  en: {
    ...
    // Auth UI English
    'auth.loginTitle': 'Sign in to Control Center',
    'auth.loginSubtitle': 'Enter operational credentials to access Downstream GPU analytics',
    'auth.email': 'Email Address',
    'auth.password': 'Password',
    'auth.fullName': 'Full Name',
    'auth.btnSignIn': 'Sign In',
    'auth.btnRegister': 'Create Account',
    'auth.noAccount': "Don't have an operational account?",
    'auth.hasAccount': 'Already have an account?',
    'auth.registerTitle': 'Operator Registration',
    'auth.registerSubtitle': 'Register new credentials to connect to downstream node clusters',
    'auth.successRegister': 'Registration successful! Redirecting to login...',
    'auth.role': 'Security Role',
    'auth.roleOperator': 'Standard Operator',
    'auth.roleAdmin': 'System Administrator',
    'auth.logout': 'Sign Out',
    'auth.errEmail': 'Please enter a valid email address.',
    'auth.errPassword': 'Password must be at least 6 characters.',
    'auth.errName': 'Full name is required.',
  },
  vi: {
    // Navigation
    ...
    // Auth UI Vietnamese
    'auth.loginTitle': 'Đăng Nhập Trung Tâm Điều Hành',
    'auth.loginSubtitle': 'Nhập thông tin xác thực để kết nối các bộ phân tích GPU lớp dưới',
    'auth.email': 'Địa chỉ Email',
    'auth.password': 'Mật khẩu',
    'auth.fullName': 'Họ và Tên',
    'auth.btnSignIn': 'Đăng Nhập',
    'auth.btnRegister': 'Tạo Tài Khoản',
    'auth.noAccount': 'Chưa có tài khoản điều hành hệ thống?',
    'auth.hasAccount': 'Đã có tài khoản điều hành?',
    'auth.registerTitle': 'Đăng Ký Điều Hành Viên',
    'auth.registerSubtitle': 'Đăng ký thông tin để cấp quyền vận hành hệ thống camera giám sát',
    'auth.successRegister': 'Đăng ký thành công! Đang chuyển hướng sang đăng nhập...',
    'auth.role': 'Vai trò Bảo mật',
    'auth.roleOperator': 'Điều hành viên',
    'auth.roleAdmin': 'Quản trị viên Hệ thống',
    'auth.logout': 'Đăng Xuất',
    'auth.errEmail': 'Vui lòng cung cấp địa chỉ email hợp lệ.',
    'auth.errPassword': 'Mật khẩu phải chứa ít nhất 6 ký tự.',
    'auth.errName': 'Họ tên không được để trống.',
  }
};
